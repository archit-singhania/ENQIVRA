...
The Flutter Phase 1 client provides registration/login, secure refresh-token restoration, workspace metrics, equipment creation/listing, case creation/history, evidence selection/upload, profile/logout, routing, theming, and API error/loading states.
